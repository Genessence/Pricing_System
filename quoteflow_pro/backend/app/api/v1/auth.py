...
async def login(user_credentials: UserLogin, db: Session = Depends(get_db)):
    ...
    if user_credentials.userType:
        user_type_lower = user_credentials.userType.lower()
        if user_type_lower == "admin":
            expected_role = UserRole.ADMIN
        elif user_type_lower == "super_admin":
            expected_role = UserRole.SUPER_ADMIN
        elif user_type_lower == "pricing_team":
            expected_role = UserRole.PRICING_TEAM
        else:
