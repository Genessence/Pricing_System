...
class Quotation(Base):
    ...
    transportation_freight = Column(Float, default=0.0, nullable=True)
    packing_charges = Column(Float, default=0.0, nullable=True)
    delivery_lead_time = Column(Integer, default=0, nullable=True)
