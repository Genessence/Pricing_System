...
class RFQItem(Base):
    ...
    transport_item_id = Column(Integer, ForeignKey("transport_items.id"), nullable=True)
    ...
    transport_item = relationship(
        "TransportItem", back_populates="rfq_items", lazy="select"
    )
