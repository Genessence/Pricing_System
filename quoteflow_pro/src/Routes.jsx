  ...
  return (
    <BrowserRouter>
      ...
      <RouterRoutes>
        ...
        <Route path="/user-dashboard/:quotationId" element={
          <ProtectedRoute allowedUserTypes={['user']}>
            <UserQuotationDetail />
          </ProtectedRoute>
        } />
        <Route path="/quotation-comparison-table" element={
        ...
        <Route path="/admin-approval-screen" element={
          <ProtectedRoute allowedUserTypes={['admin']}>
            <AdminApprovalScreen />
          </ProtectedRoute>
        } />
        <Route path="/admin-approval-screen/:quotationId" element={
          <ProtectedRoute allowedUserTypes={['admin']}>
