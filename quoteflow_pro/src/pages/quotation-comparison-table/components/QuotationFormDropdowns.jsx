...
const QuotationFormDropdowns = ({ 
  ...
  return (
    <div className="bg-card border border-border rounded-lg p-4 mb-6">
      ...
      <div className={`grid gap-6 ${selectedCommodity === 'transport' ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1 md:grid-cols-3'}`}>
        {/* Commodity Dropdown */}
        <div>
          <Select
            label="Commodity"
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-1 text-sm text-orange-700">
                <p>
                  Type of Work field is not available for Transport commodity type. Transport quotations use standard processing time.
                </p>
              </div>
            </div>
          </div>
