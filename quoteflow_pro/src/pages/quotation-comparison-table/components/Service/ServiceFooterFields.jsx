        ...
        <div className="flex items-start space-x-2">
          ...
          <div>
            ...
            <div className="text-xs text-amber-700 dark:text-amber-300 mt-1">
              Signed BOO and Signed Drawing documents are required for service
              quotations. Please ensure all mandatory documents are uploaded
              before proceeding.
            </div>
          </div>
        </div>
