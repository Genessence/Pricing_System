...
const API_BASE_URL = "https://pricing-system-d999.onrender.com/api/v1";
...
class ApiService {
  ...
  // Super admin approval for high-value RFQs
  async superAdminApproval(rfqId, finalDecisionData) {
    return await this.request(`/rfqs/${rfqId}/super-admin-approval`, {
      method: "POST",
      body: JSON.stringify(finalDecisionData),
    });
  }
